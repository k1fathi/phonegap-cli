...
module.exports = {
    create: function(phonegap) {
        return new RecipeCommand(phonegap);
    }
};

function RecipeCommand(phonegap) {
    return Command.apply(this, arguments);
}

util.inherits(RecipeCommand, Command);
...
RecipeCommand.prototype.run = function(options, callback) {
    // parse package.json
